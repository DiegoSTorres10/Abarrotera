...
@else
    ...
    <div class="container">
        <h1 class="text-center titulos"> Modificacion de proveedor</h1>
        <hr>
        ...
        <form action="{{route('proceso_modificacion')}}" method="POST" class="bg-fluid pb-3" autocomplete=off>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label mt-3" for="nombre">Id de la empresa<span>*</span></label>
                        <input required readonly class="text-dark form-control" type="text" name="id" id="id" value ="{{$proveedor->id_provedores}}"> 
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label mt-3" for="nombre">Nombre de la categoria<span>*</span></label>
                        <input required  class="text-dark form-control" type="text" name="nombre" id="nombre" value="{{$proveedor->nombre_empresa}}" placeholder="Nombre de la categoria"> 
                    </div>
                </div>
            </div>
